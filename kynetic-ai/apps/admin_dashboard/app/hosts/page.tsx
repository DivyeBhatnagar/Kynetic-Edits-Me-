          ...
          <tbody>
            {hosts.map((h) => (
              <tr key={h.id} style={{ borderBottom: '1px solid #1f2937' }}>
                ...
                <td style={{ padding: '16px' }}>{h.status}</td>
                <td style={{ padding: '16px', color: h.reputation > 0.8 ? '#10b981' : '#ef4444', fontWeight: 'bold' }}>{h.reputation}</td>
                <td style={{ padding: '16px' }}>
                  <button style={{ backgroundColor: '#f59e0b', color: 'white', border: 'none', padding: '6px 12px', borderRadius: '4px', marginRight: '8px', cursor: 'pointer' }}>Re-verify</button>
                  <button style={{ backgroundColor: '#ef4444', color: 'white', border: 'none', padding: '6px 12px', borderRadius: '4px', cursor: 'pointer' }}>Suspend / Delist</button>
                </td>
              </tr>
            ))}
          </tbody>
